        ...
        with open(file, 'rb') as f:
            ...
            try:
                ...
                for order in orders_text:
                    ...
                    if num_total_placemats == 1:
                        Order.retail_price = 15
                    elif num_total_placemats == 2:
                        Order.retail_price = 25
                    elif num_total_placemats == 3:
                        Order.retail_price = 40
                    else:
                        if Order.num_hats > 0:
                            Order.retail_price = 24.99 * Order.num_hats
                        else:
                            # FIXME: add message
                            raise Exception()
                    ...
                    if Order.country == 'Canada':
                        ...
                        # depending on the exchange rate at the time of the transaciton, but assuming that
        ...
        with open(file, 'rb') as f:
            ...
            try:
                ...
                for order in orders_text:
                    ...
                    buyer_address = '\n'.join([l.split('     ')[0] for l in addresses])
                    """
        745 E Kino Dr                                        Address      PO Box 2595
                         Mesa, AZ 85203                                                    Ann Arbor, MI 48106
...
if __name__ == "__main__":
>>>>>>> 2bf553661cabf31ef1d5cfc602885e7842661d93:old_versions/process_shipment_v2.py
    main()